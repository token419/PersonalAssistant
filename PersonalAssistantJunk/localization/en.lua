...
local PAJStrings = {
	...
	-- Auto-Launder --
    SI_PA_MENU_JUNK_AUTO_LAUNDER_HEADER = "Auto-Launder",
	SI_PA_MENU_JUNK_AUTO_LAUNDER = "Auto-Launder at Fences?",
	SI_PA_MENU_JUNK_AUTO_LAUNDER_LOCKPICKS = "Auto-Launder LockPicks?",
	SI_PA_MENU_JUNK_AUTO_LAUNDER_INGREDIENTS = "Auto-Launder Provisioning Ingredients?",
	SI_PA_MENU_JUNK_AUTO_LAUNDER_MATERIALS = "Auto-Launder Materials & Raw Materials?",
	SI_PA_MENU_JUNK_AUTO_LAUNDER_CRAFTING_BOOSTERS = "Auto-Launder Crafting Boosters?",
	SI_PA_MENU_JUNK_AUTO_LAUNDER_ENCHANTING_RUNES = "Auto-Launder Enchanting Runes?",
	SI_PA_MENU_JUNK_AUTO_LAUNDER_GLYPHS = "Auto-Launder Glyphs?",
	...
	SI_PA_MENU_JUNK_AUTO_LAUNDER_CONTAINERS = "Auto-Launder Containers?",
	...
	SI_PA_CHAT_JUNK_AUTO_LAUNDERED = table.concat({PAC.COLOR.ORANGE_RED:Colorize("Laundered"), " %d x %s (Price paid: %s)"}),
