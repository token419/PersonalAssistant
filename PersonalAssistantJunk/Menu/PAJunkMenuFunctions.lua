...
local function isPAJunkMiscellaneousMenuDisabled()
    ...
    if isDisabled({"Miscellaneous", "autoMarkTreasure"}) then
        if tonumber(getValue({"Miscellaneous", "autoMarkGlyphQualityThreshold"})) == PAC.ITEM_QUALITY.DISABLED then 
           if tonumber(getValue({"Miscellaneous", "autoMarkCompanionItemsQualityThreshold"})) == PAC.ITEM_QUALITY.DISABLED then return true end  		
		end
    end
...
local PAJunkMenuFunctions = {
	...
	isCompanionItemsAutoMarkQualityTresholdDisabled = function() return isDisabled({"autoMarkAsJunkEnabled"}) end,	
    getCompanionItemsAutoMarkQualityTresholdSetting = function() return getValue({"Miscellaneous", "autoMarkCompanionItemsQualityThreshold"}) end,
    setCompanionItemsAutoMarkQualityTresholdSetting = function(value) setValue(value, {"Miscellaneous", "autoMarkCompanionItemsQualityThreshold"}) end,
    ...
    -- AUTO Launder
    -- -----------------------------
    isAutoLaunderDisabled = function() return isDisabled() end, -- currently always enabled
    getAutoLaunderSetting = function() return getValue({"autoLaunderEnabled"}) end,
    setAutoLaunderSetting = function(value) setValueAndRefreshEvents(value, {"autoLaunderEnabled"}) end,
	isAutoLaunderMenuDisabled = function() return isDisabled({"autoLaunderEnabled"}) or isDisabledAll({"AutoLaunder", "autoLaunderLockPicks"}, {"AutoLaunder", "autoLaunderIngredients"}, 
	{"AutoLaunder", "autoLaunderMaterials"}, {"AutoLaunder", "autoLaunderCraftingBoosters"}, {"AutoLaunder", "autoLaunderEnchantingRunes"}, {"AutoLaunder", "autoLaunderGlyphs"},
	{"AutoLaunder", "autoLaunderFurnishing"}, {"AutoLaunder", "autoLaunderSoulGems"}, {"AutoLaunder", "autoLaunderTreasures"}, {"AutoLaunder", "autoLaunderRecipes"},
	{"AutoLaunder", "autoLaunderMotifs"}, {"AutoLaunder", "autoLaunderEdicts"}, {"AutoLaunder", "autoLaunderContainers"}) end,

    isAutoLaunderLockPicksDisabled = function() return isDisabled({"autoLaunderEnabled"}) end,
    getAutoLaunderLockPicksSetting = function() return getValue({"AutoLaunder", "autoLaunderLockPicks"}) end,
    setAutoLaunderLockPicksSetting = function(value) setValueAndRefreshEvents(value, {"AutoLaunder", "autoLaunderLockPicks"}) end,

    isAutoLaunderIngredientsDisabled = function() return isDisabled({"autoLaunderEnabled"}) end,
    getAutoLaunderIngredientsSetting = function() return getValue({"AutoLaunder", "autoLaunderIngredients"}) end,
    setAutoLaunderIngredientsSetting = function(value) setValueAndRefreshEvents(value, {"AutoLaunder", "autoLaunderIngredients"}) end,	
	
    isAutoLaunderMaterialsDisabled = function() return isDisabled({"autoLaunderEnabled"}) end,
    getAutoLaunderMaterialsSetting = function() return getValue({"AutoLaunder", "autoLaunderMaterials"}) end,
    setAutoLaunderMaterialsSetting = function(value) setValueAndRefreshEvents(value, {"AutoLaunder", "autoLaunderMaterials"}) end,	
	
    isAutoLaunderCraftingBoostersDisabled = function() return isDisabled({"autoLaunderEnabled"}) end,
    getAutoLaunderCraftingBoostersSetting = function() return getValue({"AutoLaunder", "autoLaunderCraftingBoosters"}) end,
    setAutoLaunderCraftingBoostersSetting = function(value) setValueAndRefreshEvents(value, {"AutoLaunder", "autoLaunderCraftingBoosters"}) end,

	isAutoLaunderEnchantingRunesDisabled = function() return isDisabled({"autoLaunderEnabled"}) end,
    getAutoLaunderEnchantingRunesSetting = function() return getValue({"AutoLaunder", "autoLaunderEnchantingRunes"}) end,
    setAutoLaunderEnchantingRunesSetting = function(value) setValueAndRefreshEvents(value, {"AutoLaunder", "autoLaunderEnchantingRunes"}) end,
	
	isAutoLaunderGlyphsDisabled = function() return isDisabled({"autoLaunderEnabled"}) end,
    getAutoLaunderGlyphsSetting = function() return getValue({"AutoLaunder", "autoLaunderGlyphs"}) end,
    setAutoLaunderGlyphsSetting = function(value) setValueAndRefreshEvents(value, {"AutoLaunder", "autoLaunderGlyphs"}) end,
	
	isAutoLaunderFurnishingDisabled = function() return isDisabled({"autoLaunderEnabled"}) end,
    getAutoLaunderFurnishingSetting = function() return getValue({"AutoLaunder", "autoLaunderFurnishing"}) end,
    setAutoLaunderFurnishingSetting = function(value) setValueAndRefreshEvents(value, {"AutoLaunder", "autoLaunderFurnishing"}) end,
	
	isAutoLaunderSoulGemsDisabled = function() return isDisabled({"autoLaunderEnabled"}) end,
    getAutoLaunderSoulGemsSetting = function() return getValue({"AutoLaunder", "autoLaunderSoulGems"}) end,
    setAutoLaunderSoulGemsSetting = function(value) setValueAndRefreshEvents(value, {"AutoLaunder", "autoLaunderSoulGems"}) end,
	
	isAutoLaunderTreasuresDisabled = function() return isDisabled({"autoLaunderEnabled"}) end,
	...
	isAutoLaunderMotifsDisabled = function() return isDisabled({"autoLaunderEnabled"}) end,
    getAutoLaunderMotifsSetting = function() return getValue({"AutoLaunder", "autoLaunderMotifs"}) end,
    setAutoLaunderMotifsSetting = function(value) setValueAndRefreshEvents(value, {"AutoLaunder", "autoLaunderMotifs"}) end,
	
	isAutoLaunderEdictsDisabled = function() return isDisabled({"autoLaunderEnabled"}) end,
    getAutoLaunderEdictsSetting = function() return getValue({"AutoLaunder", "autoLaunderEdicts"}) end,
    setAutoLaunderEdictsSetting = function(value) setValueAndRefreshEvents(value, {"AutoLaunder", "autoLaunderEdicts"}) end,
	
	isAutoLaunderContainersDisabled = function() return isDisabled({"autoLaunderEnabled"}) end,
    getAutoLaunderContainersSetting = function() return getValue({"AutoLaunder", "autoLaunderContainers"}) end,
    setAutoLaunderContainersSetting = function(value) setValueAndRefreshEvents(value, {"AutoLaunder", "autoLaunderContainers"}) end,
