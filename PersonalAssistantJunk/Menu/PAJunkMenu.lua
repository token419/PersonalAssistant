...
local PAJAutoLaunderSubMenu = setmetatable({}, { __index = table })
...
local function _createPAJunkMenu()
    ...
    PAJunkOptionsTable:insert({
        type = "header",
        name = PAC.COLOR.YELLOW:Colorize(GetString(SI_PA_MENU_JUNK_AUTO_LAUNDER_HEADER))
    })
	
     PAJunkOptionsTable:insert({
        type = "checkbox",
        name = GetString(SI_PA_MENU_JUNK_AUTO_LAUNDER),
        getFunc = PAJMenuFunctions.getAutoLaunderSetting,
        setFunc = PAJMenuFunctions.setAutoLaunderSetting,
        disabled = PAJMenuFunctions.isAutoLaunderDisabled,
        default = PAJMenuDefaults.autoLaunderEnabled,
    })
	
	PAJunkOptionsTable:insert({
        type = "submenu",
        name = GetString(SI_PA_MENU_JUNK_AUTO_LAUNDER_HEADER), 
        icon = PAC.ICONS.OTHERS.FENCE.PATH,
        iconTextureCoords = PAC.ICONS.TEXTURE_COORDS.MEDIUM,
        controls = PAJAutoLaunderSubMenu,
        disabledLabel = PAJMenuFunctions.isAutoLaunderMenuDisabled,
    })
...
local function _createPAJAutoLaunderSubMenu() 
	PAJAutoLaunderSubMenu:insert({
        type = "checkbox",
        name = GetString(SI_PA_MENU_JUNK_AUTO_LAUNDER_LOCKPICKS),
        getFunc = PAJMenuFunctions.getAutoLaunderLockPicksSetting,
        setFunc = PAJMenuFunctions.setAutoLaunderLockPicksSetting,
        disabled = PAJMenuFunctions.isAutoLaunderLockPicksDisabled,
        default = PAJMenuDefaults.AutoLaunder.autoLaunderLockPicks,
    })
	
	PAJAutoLaunderSubMenu:insert({
        type = "checkbox",
        name = GetString(SI_PA_MENU_JUNK_AUTO_LAUNDER_EDICTS),
        getFunc = PAJMenuFunctions.getAutoLaunderEdictsSetting,
        setFunc = PAJMenuFunctions.setAutoLaunderEdictsSetting,
        disabled = PAJMenuFunctions.isAutoLaunderEdictsDisabled,
        default = PAJMenuDefaults.AutoLaunder.autoLaunderEdicts,
    })
	
	PAJAutoLaunderSubMenu:insert({
        type = "checkbox",
        name = GetString(SI_PA_MENU_JUNK_AUTO_LAUNDER_SOULGEMS),
        getFunc = PAJMenuFunctions.getAutoLaunderSoulGemsSetting,
        setFunc = PAJMenuFunctions.setAutoLaunderSoulGemsSetting,
        disabled = PAJMenuFunctions.isAutoLaunderSoulGemsDisabled,
        default = PAJMenuDefaults.AutoLaunder.autoLaunderSoulGems,
    })
	
	PAJAutoLaunderSubMenu:insert({
        type = "checkbox",
        name = GetString(SI_PA_MENU_JUNK_AUTO_LAUNDER_INGREDIENTS),
        getFunc = PAJMenuFunctions.getAutoLaunderIngredientsSetting,
        setFunc = PAJMenuFunctions.setAutoLaunderIngredientsSetting,
        disabled = PAJMenuFunctions.isAutoLaunderIngredientsDisabled,
        default = PAJMenuDefaults.AutoLaunder.autoLaunderIngredients,
    })
	
	PAJAutoLaunderSubMenu:insert({
        type = "checkbox",
        name = GetString(SI_PA_MENU_JUNK_AUTO_LAUNDER_MATERIALS),
        getFunc = PAJMenuFunctions.getAutoLaunderMaterialsSetting,
        setFunc = PAJMenuFunctions.setAutoLaunderMaterialsSetting,
        disabled = PAJMenuFunctions.isAutoLaunderMaterialsDisabled,
        default = PAJMenuDefaults.AutoLaunder.autoLaunderMaterials,
    })
	
	PAJAutoLaunderSubMenu:insert({
        type = "checkbox",
        name = GetString(SI_PA_MENU_JUNK_AUTO_LAUNDER_CRAFTING_BOOSTERS),
        getFunc = PAJMenuFunctions.getAutoLaunderCraftingBoostersSetting,
        setFunc = PAJMenuFunctions.setAutoLaunderCraftingBoostersSetting,
        disabled = PAJMenuFunctions.isAutoLaunderCraftingBoostersDisabled,
        default = PAJMenuDefaults.AutoLaunder.autoLaunderCraftingBoosters,
    })
	
	PAJAutoLaunderSubMenu:insert({
        type = "checkbox",
        name = GetString(SI_PA_MENU_JUNK_AUTO_LAUNDER_ENCHANTING_RUNES),
        getFunc = PAJMenuFunctions.getAutoLaunderEnchantingRunesSetting,
        setFunc = PAJMenuFunctions.setAutoLaunderEnchantingRunesSetting,
        disabled = PAJMenuFunctions.isAutoLaunderEnchantingRunesDisabled,
        default = PAJMenuDefaults.AutoLaunder.autoLaunderEnchantingRunes,
    })
	
	PAJAutoLaunderSubMenu:insert({
        type = "checkbox",
        name = GetString(SI_PA_MENU_JUNK_AUTO_LAUNDER_GLYPHS),
        getFunc = PAJMenuFunctions.getAutoLaunderGlyphsSetting,
        setFunc = PAJMenuFunctions.setAutoLaunderGlyphsSetting,
        disabled = PAJMenuFunctions.isAutoLaunderGlyphsDisabled,
        default = PAJMenuDefaults.AutoLaunder.autoLaunderGlyphs,
    })
	
	PAJAutoLaunderSubMenu:insert({
        type = "checkbox",
        name = GetString(SI_PA_MENU_JUNK_AUTO_LAUNDER_FURNISHING),
        getFunc = PAJMenuFunctions.getAutoLaunderFurnishingSetting,
        setFunc = PAJMenuFunctions.setAutoLaunderFurnishingSetting,
        disabled = PAJMenuFunctions.isAutoLaunderFurnishingDisabled,
        default = PAJMenuDefaults.AutoLaunder.autoLaunderFurnishing,
    })	
	
	PAJAutoLaunderSubMenu:insert({
        type = "checkbox",
        name = GetString(SI_PA_MENU_JUNK_AUTO_LAUNDER_TREASURES),
        getFunc = PAJMenuFunctions.getAutoLaunderTreasuresSetting,
        setFunc = PAJMenuFunctions.setAutoLaunderTreasuresSetting,
        disabled = PAJMenuFunctions.isAutoLaunderTreasuresDisabled,
        default = PAJMenuDefaults.AutoLaunder.autoLaunderTreasures,
    })
	...
	PAJAutoLaunderSubMenu:insert({
        ...
        disabled = PAJMenuFunctions.isAutoLaunderRecipesDisabled,
        default = PAJMenuDefaults.AutoLaunder.autoLaunderRecipes,
    })
	
	PAJAutoLaunderSubMenu:insert({
        type = "checkbox",
        name = GetString(SI_PA_MENU_JUNK_AUTO_LAUNDER_MOTIFS),
        getFunc = PAJMenuFunctions.getAutoLaunderMotifsSetting,
        setFunc = PAJMenuFunctions.setAutoLaunderMotifsSetting,
        disabled = PAJMenuFunctions.isAutoLaunderMotifsDisabled,
        default = PAJMenuDefaults.AutoLaunder.autoLaunderMotifs,
    })
	
	PAJAutoLaunderSubMenu:insert({
        type = "checkbox",
        name = GetString(SI_PA_MENU_JUNK_AUTO_LAUNDER_CONTAINERS),
        getFunc = PAJMenuFunctions.getAutoLaunderContainersSetting,
        setFunc = PAJMenuFunctions.setAutoLaunderContainersSetting,
        disabled = PAJMenuFunctions.isAutoLaunderContainersDisabled,
        default = PAJMenuDefaults.AutoLaunder.autoLaunderContainers,
    })
