...
local function _getBagNameAndOperatorTextFromOperatorId(operatorId)
	...
	if operatorId > PAC.OPERATOR.BACKPACK_GREATERTHANOREQUAL then
		if operatorId < PAC.OPERATOR.BAG_HOUSE_BANK_ONE_EQUAL then
			-- BAG = Bank
			bagName = PAHF.getBagName(BAG_BANK)
			operator = operatorId - 5
			
		elseif operatorId < PAC.OPERATOR.BAG_HOUSE_BANK_TWO_EQUAL then	
		       bagName = PAHF.getBagName(BAG_HOUSE_BANK_ONE) 
		       operator = operatorId - 10 
		elseif operatorId < PAC.OPERATOR.BAG_HOUSE_BANK_THREE_EQUAL then
		       bagName = PAHF.getBagName(BAG_HOUSE_BANK_TWO) 
		       operator = operatorId - 15
		elseif operatorId < PAC.OPERATOR.BAG_HOUSE_BANK_FOUR_EQUAL then
		       bagName = PAHF.getBagName(BAG_HOUSE_BANK_THREE) 
		       operator = operatorId - 20	
		elseif operatorId < PAC.OPERATOR.BAG_HOUSE_BANK_FIVE_EQUAL then
		       bagName = PAHF.getBagName(BAG_HOUSE_BANK_FOUR) 
		       operator = operatorId - 25
		elseif operatorId < PAC.OPERATOR.BAG_HOUSE_BANK_SIX_EQUAL then
		       bagName = PAHF.getBagName(BAG_HOUSE_BANK_FIVE) 
		       operator = operatorId - 30
		elseif operatorId < PAC.OPERATOR.BAG_HOUSE_BANK_SEVEN_EQUAL then
		       bagName = PAHF.getBagName(BAG_HOUSE_BANK_SIX) 
		       operator = operatorId - 35
		elseif operatorId < PAC.OPERATOR.BAG_HOUSE_BANK_EIGHT_EQUAL then
		       bagName = PAHF.getBagName(BAG_HOUSE_BANK_SEVEN) 
		       operator = operatorId - 40
		elseif operatorId < PAC.OPERATOR.BAG_HOUSE_BANK_NINE_EQUAL then
		       bagName = PAHF.getBagName(BAG_HOUSE_BANK_EIGHT) 
		       operator = operatorId - 45
		elseif operatorId < PAC.OPERATOR.BAG_HOUSE_BANK_TEN_EQUAL then
		       bagName = PAHF.getBagName(BAG_HOUSE_BANK_NINE) 
		       operator = operatorId - 50
        else
		       bagName = PAHF.getBagName(BAG_HOUSE_BANK_TEN) 
		       operator = operatorId - 55
		end
