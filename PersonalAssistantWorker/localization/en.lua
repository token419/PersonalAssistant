...
local PAWStrings = {
    ...
    -- -----------------------------------------------------------------------------------------------------------------
    -- PAWorker Menu --
    SI_PA_MENU_WORKER_DESCRIPTION = "PAWorker can deconstruct items, refine materials and research traits automatically",
	...
	SI_PA_MENU_WORKER_PROTECT_UNCOLLECTED_SET_ITEMS_ENABLE = "Protect Uncollected Set Items",
	SI_PA_MENU_WORKER_PROTECT_UNCOLLECTED_SET_ITEMS_ENABLE_T = "Protect uncollected set items from auto-deconstruction",
	...
	SI_PA_CHAT_RESEARCH_BUSY = "Could not research %s trait because you are aleady researching another trait for %s",
	SI_PA_CHAT_NO_METICULOUS = "Auto deconstruct/refine is blocked because Meticulous Disassembly is not slotted",
