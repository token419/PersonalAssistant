...
local PAWorkerMenuFunctions = {
    ...
    getAutoExitCraftingSetting = function() return getValue({"autoExitCrafting"}) end,
    setAutoExitCraftingSetting = function(value) setValue(value, {"autoExitCrafting"}) end,
...
PersonalAssistant.IsAutomaticCraftingStationCloseEnabled = function() return PersonalAssistant.MenuFunctions.PAWorker.getAutoExitCraftingSetting() end