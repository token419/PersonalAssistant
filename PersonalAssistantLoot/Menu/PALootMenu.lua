...
local PALLootScribingScriptsSubmenuTable = setmetatable({}, { __index = table })
...
local PALLootAutoCombineSubmenuTable = setmetatable({}, { __index = table })

local PALMarkRecipesSubmenuTable = setmetatable({}, { __index = table })
local PALMarkScribingSubmenuTable = setmetatable({}, { __index = table })
...
local function _createPALootMenu()
    ...
    PALootOptionsTable:insert({
        type = "submenu",
        name = GetString(SI_PA_MENU_LOOT_SCRIBING_SCRIPTS_HEADER),
        icon = PAC.ICONS.ITEMS.SCRIBING_SCRIPT.PATH,
        controls = PALLootScribingScriptsSubmenuTable,
        disabledLabel = PALMenuFunctions.isLootScribingScriptsMenuDisabled,
    })	
    ...
    PALootOptionsTable:insert({
        type = "submenu",
        name = GetString(SI_PA_MENU_LOOT_AUTO_COMBINE_HEADER),
        icon = PAC.ICONS.CRAFTBAG.COLLECTIBLES.PATH,
        iconTextureCoords = PAC.ICONS.TEXTURE_COORDS.MEDIUM,
        controls = PALLootAutoCombineSubmenuTable,
        disabledLabel = PALMenuFunctions.isLootAutoCombineMenuDisabled,
    })
    ...
    PALootOptionsTable:insert({
        type = "submenu",
        name = GetString(SI_PA_MENU_LOOT_ICONS_SCRIBING_HEADER),
        icon = PAC.ICONS.ITEMS.SCRIBING_SCRIPT.PATH,
        controls = PALMarkScribingSubmenuTable,
        disabledLabel = PALMenuFunctions.isMarkScribingMenuDisabled,
    })
...
local function _createPALLootRecipesSubmenuTable()
    ...
    PALLootRecipesSubmenuTable:insert({
        ...
        default = PALMenuDefaults.LootEvents.LootStyles.autoLearnRecipe,
    })
	
    PALLootRecipesSubmenuTable:insert({
        type = "checkbox",
        name = GetString(SI_PA_MENU_LOOT_AUTO_LEARN_FURNISHING_PLAN),
        tooltip = GetString(SI_PA_MENU_LOOT_AUTO_LEARN_FURNISHING_PLAN_T),
        getFunc = PALMenuFunctions.getAutoLearnFurnishingPlanSetting,
        setFunc = PALMenuFunctions.setAutoLearnFurnishingPlanSetting,
        disabled = PALMenuFunctions.isAutoLearnFurnishingPlanDisabled,
        default = PALMenuDefaults.LootEvents.LootStyles.autoLearnFurnishingPlan,
    })
	
    PALLootRecipesSubmenuTable:insert({
        type = "checkbox",
        name = GetString(SI_PA_MENU_LOOT_AUTO_MARK_AS_JUNK_KNOWN),
        tooltip = GetString(SI_PA_MENU_LOOT_AUTO_MARK_AS_JUNK_KNOWN_T),
        getFunc = PALMenuFunctions.getAutoMarkAsJunkRecipeSetting,
        setFunc = PALMenuFunctions.setAutoMarkAsJunkRecipeSetting,
        disabled = PALMenuFunctions.isAutoMarkAsJunkRecipeDisabled,
        default = PALMenuDefaults.LootEvents.LootStyles.autoMarkAsJunkRecipes,
    })
end

-- -----------------------------------------------------------------------------------------------------------------

local function _createPALLootScribingScriptsSubmenuTable()
    PALLootScribingScriptsSubmenuTable:insert({
        type = "description",
        text = GetString(SI_PA_DISPLAY_A_MESSAGE_WHEN),
        disabled = PALMenuFunctions.isLootScribingScriptsMenuDisabled,
    })

    PALLootScribingScriptsSubmenuTable:insert({
        type = "checkbox",
        name = GetString(SI_PA_MENU_LOOT_SCRIBING_SCRIPTS_UNKNOWN_MSG),
        tooltip = GetString(SI_PA_MENU_LOOT_SCRIBING_SCRIPTS_UNKNOWN_MSG_T),
        getFunc = PALMenuFunctions.getUnknownScribingScriptsMsgSetting,
        setFunc = PALMenuFunctions.setUnknownScribingScriptsMsgSetting,
        disabled = PALMenuFunctions.isUnknownScribingScriptsMsgDisabled,
        default = PALMenuDefaults.LootEvents.LootStyles.unknownScribingScriptsMsg,
    })
	
    PALLootScribingScriptsSubmenuTable:insert({
        type = "checkbox",
        name = GetString(SI_PA_MENU_LOOT_AUTO_LEARN_SCRIBING_SCRIPTS),
        tooltip = GetString(SI_PA_MENU_LOOT_AUTO_LEARN_SCRIBING_SCRIPTS_T),
        getFunc = PALMenuFunctions.getAutoLearnScribingScriptsSetting,
        setFunc = PALMenuFunctions.setAutoLearnScribingScriptsSetting,
        disabled = PALMenuFunctions.isAutoLearnScribingScriptsDisabled,
        default = PALMenuDefaults.LootEvents.LootStyles.autoLearnScribingScripts,
    })
	...
	PALLootScribingScriptsSubmenuTable:insert({
        ...
        name = GetString(SI_PA_MENU_LOOT_AUTO_MARK_AS_JUNK_KNOWN),
        tooltip = GetString(SI_PA_MENU_LOOT_AUTO_MARK_AS_JUNK_KNOWN_T),
        getFunc = PALMenuFunctions.getAutoMarkAsJunkScribingScriptsSetting,
        setFunc = PALMenuFunctions.setAutoMarkAsJunkScribingScriptsSetting,
        disabled = PALMenuFunctions.isAutoMarkAsJunkScribingScriptsDisabled,
        default = PALMenuDefaults.LootEvents.LootStyles.autoMarkAsJunkScribingScripts,
    })
	
    PALLootScribingScriptsSubmenuTable:insert({
        type = "checkbox",
        name = GetString(SI_PA_MENU_LOOT_AUTO_LEARN_SCRIBING_GRIMOIRES),
        tooltip = GetString(SI_PA_MENU_LOOT_AUTO_LEARN_SCRIBING_GRIMOIRES_T),
        getFunc = PALMenuFunctions.getAutoLearnScribingGrimoiresSetting,
        setFunc = PALMenuFunctions.setAutoLearnScribingGrimoiresSetting,
        disabled = PALMenuFunctions.isAutoLearnScribingGrimoiresDisabled,
        default = PALMenuDefaults.LootEvents.LootStyles.autoLearnScribingGrimoires,
    })
	...
	PALLootScribingScriptsSubmenuTable:insert({
        ...
        name = GetString(SI_PA_MENU_LOOT_AUTO_MARK_AS_JUNK_KNOWN),
        tooltip = GetString(SI_PA_MENU_LOOT_AUTO_MARK_AS_JUNK_KNOWN_T),
        getFunc = PALMenuFunctions.getAutoMarkAsJunkScribingGrimoiresSetting,
        setFunc = PALMenuFunctions.setAutoMarkAsJunkScribingGrimoiresSetting,
        disabled = PALMenuFunctions.isAutoMarkAsJunkScribingGrimoiresDisabled,
        default = PALMenuDefaults.LootEvents.LootStyles.autoMarkAsJunkScribingGrimoires,
    })
end
...
local function _createPALLootApparelWeaponsSubmenuTable()
    ...
    PALLootApparelWeaponsSubmenuTable:insert({
        type = "checkbox",
        name = GetString(SI_PA_MENU_LOOT_APPARELWEAPONS_AUTOBIND),
        tooltip = GetString(SI_PA_MENU_LOOT_APPARELWEAPONS_AUTOBIND_T),
        getFunc = PALMenuFunctions.getAutoBindSetting,
        setFunc = PALMenuFunctions.setAutoBindSetting,
        disabled = PALMenuFunctions.isAutoBindDisabled,
        default = PALMenuDefaults.LootEvents.LootApparelWeapons.autoBind,
    })
end
...
local function _createPALLootAutoCombineSubmenuTable()

    PALLootAutoCombineSubmenuTable:insert({
        type = "checkbox",
        name = GetString(SI_PA_MENU_LOOT_AUTO_COMBINE),
		tooltip = GetString(SI_PA_MENU_LOOT_AUTO_COMBINE_T),
        getFunc = PALMenuFunctions.getAutoCombineSetting,
        setFunc = PALMenuFunctions.setAutoCombineSetting,
        disabled = PALMenuFunctions.isAutoCombineDisabled,
        default = PALMenuDefaults.ItemIcons.Recipes.showUnknownIcon,
    })
end
...
local function _createPALMarkScribingSubmenuTable()
    PALMarkScribingSubmenuTable:insert({
        type = "description",
        text = GetString(SI_PA_MARK_WITH),
        disabled = PALMenuFunctions.isMarkScribingMenuDisabled,
    })

    PALMarkScribingSubmenuTable:insert({
        type = "checkbox",
        name = GetString(SI_PA_MENU_LOOT_ICONS_SCRIBING_SHOW_UNKNOWN),
        getFunc = PALMenuFunctions.getMarkUnknownScribingSetting,
        setFunc = PALMenuFunctions.setMarkUnknownScribingSetting,
        disabled = PALMenuFunctions.isMarkUnknownScribingDisabled,
        default = PALMenuDefaults.ItemIcons.Scribing.showUnknownIcon,
    })

    PALMarkScribingSubmenuTable:insert({
        type = "checkbox",
        name = GetString(SI_PA_MENU_LOOT_ICONS_SCRIBING_SHOW_KNOWN),
        getFunc = PALMenuFunctions.getMarkKnownScribingSetting,
        setFunc = PALMenuFunctions.setMarkKnownScribingSetting,
        disabled = PALMenuFunctions.isMarkKnownScribingDisabled,
        default = PALMenuDefaults.ItemIcons.Scribing.showKnownIcon,
    })
end
