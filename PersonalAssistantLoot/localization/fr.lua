...
local PALStrings = {
	...
	SI_PA_MENU_LOOT_AUTO_FILLET_HEADER = table.concat({"Lors de la récupération de ", GetString("SI_ITEMTYPE", ITEMTYPE_FISH)}),
	SI_PA_MENU_LOOT_AUTO_FILLET = "Dépouiller automatiquement les poissons communs",
	SI_PA_MENU_LOOT_AUTO_FILLET_T = "Dépouille automatiquement les poissons communs pour obtenir du poisson ou du caviar parfait",
	...
	SI_PA_CHAT_LOOT_SCRIBING_SCRIPT_UNKNOWN = table.concat({PAC.ICONS.OTHERS.UNKNOWN.SMALL, "%s peut être ", PAC.COLORS.ORANGE,"appris", PAC.COLORS.DEFAULT, " !"}),
    ...
    --SI_PA_CHAT_LOOT_SET_UNCOLLECTED = table.concat({PAC.ICONS.OTHERS.UNCOLLECTED.SMALL, "%s"}),
	SI_PA_CHAT_LOOT_AUTO_FILLET = "%s est en cours de filetage automatique.",
