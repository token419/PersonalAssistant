...
PersonalAssistant.Constants = {
    ADDON = {
        NAME_RAW = {
            ...
            REPAIR = "PersonalAssistant Repair & Restock",
        ...
        NAME_DISPLAY = {
            ...
            REPAIR = table.concat({"|cFFD700", "P", "|r", "|cFFFFFF", "ersonal", "|r", "|cFFD700", "A", "|r", "|cFFFFFF", "ssistant ", "|r", "|cFFD700", "R", "|r", "|cFFFFFF", "epair & ", "|r", "|cFFD700", "R", "|r", "|cFFFFFF", "estock", "|r",}),
    ...
    COLORED_TEXTS = {
        ...
        PAR = table.concat({"|cFFD700", "PA R", "|r", "|cFFFFFF", "epair & ", "|r", "|cFFD700", "R", "|r", "|cFFFFFF", "estock", "|r"}),
    ...
    ICONS = {
        ...
        CRAFTBAG = {
            ...
            SCRIBING = {
                PATH = "/esoui/art/crafting/scribing_tabicon_scribing_up.dds",
            },
        },
        ITEMS = {
            FOOD = {
            ...
            STYLE_PAGE = {
                PATH = "/esoui/art/icons/quest_summerset_completed_report.dds",
            },
            SCRIBING_SCRIPT = {
                PATH = "/esoui/art/crafting/scribing_tabicon_scribing_up.dds",
            },
            ...
            CYRODIILREPAIRKIT = {
                PATH = "/esoui/art/icons/u41_ava_unifiedrepairkit.dds",
            },
        ...
        OTHERS = {
            ...
            UNCOLLECTED = {
                ...
                SMALL = string.format("|c66ECFF%s|r", zo_iconFormatInheritColor("/esoui/art/icons/emotes/emotecategoryicon_collected.dds", 24, 24)),
            },
            COMPANION = {
                PATH = "/esoui/art/dye/gamepad/dye_tabicon_companioncostumedye.dds",
                NORMAL = string.format("|cFFBF00%s|r", zo_iconFormatInheritColor("/esoui/art/dye/gamepad/dye_tabicon_companioncostumedye.dds", 32, 32)),
                SMALL = string.format("|cFFBF00%s|r", zo_iconFormatInheritColor("/esoui/art/dye/gamepad/dye_tabicon_companioncostumedye.dds", 24, 24)),
            }
        }
    },
    ...
    OPERATOR = {
        ...
        BAG_HOUSE_BANK_TEN_GREATERTHANOREQUAL = 60,
    },
