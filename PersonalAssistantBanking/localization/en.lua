...
local PABStrings = {
    ...
    SI_PA_MENU_BANKING_ADVANCED_KNOWN_ITEMTYPE72 = table.concat({PAC.ICONS.OTHERS.KNOWN.NORMAL, " Known "..GetString("SI_ITEMTYPE", ITEMTYPE_CRAFTED_ABILITY)}),
    ...
    SI_PA_MENU_BANKING_ADVANCED_UNKNOWN_ITEMTYPE72 = table.concat({PAC.ICONS.OTHERS.UNKNOWN.NORMAL, " Unknown "..GetString("SI_ITEMTYPE", ITEMTYPE_CRAFTED_ABILITY)}),
	...
	SI_PA_MENU_BANKING_ADVANCED_UNKNOWN_STYLE_PAGE = table.concat({PAC.ICONS.OTHERS.UNKNOWN.NORMAL, " Unknown Style Pages"}),
